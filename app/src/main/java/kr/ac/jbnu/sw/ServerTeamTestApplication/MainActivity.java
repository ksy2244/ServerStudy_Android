...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable @org.jetbrains.annotations.Nullable Intent data) {
        ...
        if (requestCode == 1) {
            ...
            } else if (resultCode == DataAddActivity.ADD_FAIL) {

            } else if (resultCode == DataAddActivity.USER_CANCEL) {
    ...
    private void receiveServerData() {
        try {
            ...
            HttpUrl.Builder urlBuilder = HttpUrl.parse("http://ampmservertest.namsu.site:8080/ksoyeon-0.0.1-SNAPSHOT/").newBuilder();
